...
![image-20211011202658109](./nodes/deploy/image-20211011202658109.png)
...
1. 新建会话
   <img src="./nodes/deploy/image-20211011203212635.png" alt="image-20211011203212635" style="zoom:50%;" />
2. 确定会话信息，协议为 `SSH`、主机为服务器 IP、端口号为 22
   <img src="./nodes/deploy/image-20211011203403394.png" alt="image-20211011203403394" style="zoom:67%;" />
3. 双击会话进行连接
   ![image-20211011203436662](./nodes/deploy/image-20211011203436662.png)
4. 输入你的用户名（默认为 `root`）
   ![image-20211011203504688](./nodes/deploy/image-20211011203504688.png)
5. 输入你的密码
   <img src="./nodes/deploy/image-20211011203533726.png" alt="image-20211011203533726" style="zoom:67%;" />
6. 出现此信息，表示连接成功
   <img src="./nodes/deploy/image-20211011203631626.png" alt="image-20211011203631626" style="zoom:50%;" />
